package tech.kayys.alkhawarizm.mlx;

import org.junit.jupiter.api.Test;
import tech.kayys.alkhawarizm.mlx.binding.MlxBinding;
...
public class MlxTest {
    ...
    public void testMatmul() {
        ...
        Path libPath = Paths.get("build/native/lib/libalkhawarizm_mlx_bridge.dylib").toAbsolutePath();
