 ...
 *
 * <p>
 * Loads the FA4 symbols ({@code alkhawarizm_metal_fa4_attention}, etc.) from
 * {@code libalkhawarizm_metal.dylib} — the same dylib as {@link MetalBinding},
 * compiled from the modular Metal sources, including
 * {@code alkhawarizm_metal_fa4.m}.
 *
...
public class MetalFlashAttentionBinding {
    ...
    private static final String FN_FA4_ATTENTION = "alkhawarizm_metal_fa4_attention";
    private static final String FN_SDPA_AVAILABLE = "alkhawarizm_metal_fa4_sdpa_available";
    private static final String FN_BF16_AVAILABLE = "alkhawarizm_metal_fa4_bf16_available";
    ...
    /**
     * Load FA4 symbols from {@code libalkhawarizm_metal.dylib}.
     ...
     * {@link tech.kayys.alkhawarizm.kvcache.PagedKVCacheManager#getBlockPool()}
    ...
    public int fa4Attention(
        ...
        try {
            ...
            logCpuFallbackOnce(
                    "Failed to invoke " + FN_FA4_ATTENTION + "; falling back to CPU attention: " + e.getMessage());
            return MetalFlashAttentionCpuFallback.execute(
                    output, query, key, value,
                    B, T, S, H, H_kv, D, scale, isCausal, softCap);
        }
    ...
    private void logCpuFallbackOnce(String reason) {
    ...
    private void bindAll() {
        // int alkhawarizm_metal_fa4_attention(void*, void*, void*, void*,
        ...
        // int alkhawarizm_metal_fa4_sdpa_available() -> int
        bind(FN_SDPA_AVAILABLE, FunctionDescriptor.of(ValueLayout.JAVA_INT));

        // int alkhawarizm_metal_fa4_bf16_available() -> int
