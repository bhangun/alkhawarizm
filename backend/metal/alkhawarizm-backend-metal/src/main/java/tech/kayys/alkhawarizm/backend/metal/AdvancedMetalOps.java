package tech.kayys.alkhawarizm.metal;

import java.lang.foreign.MemorySegment;

/**
 * Extensible interface exposing advanced, fused operations natively available
 * in Metal MPS.
 * 
 * <p>
 * High-level orchestration runners (like Safetensor or GGUF generation engines)
 * can query if their active {@code ComputeBackend} implements this interface.
 * If so, they can bypass sequential generic array iterations and leverage these
 * directly
