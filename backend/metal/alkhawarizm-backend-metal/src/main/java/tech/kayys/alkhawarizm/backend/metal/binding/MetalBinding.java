 ...
 * function (in {@code alkhawarizm_metal_buffers.m}) calls
 ...
 *         Path.of("/opt/alkhawarizm/lib/libalkhawarizm_metal.dylib"));
...
public class MetalBinding {
    ...
    private static final String FN_INIT = "alkhawarizm_metal_init";
    private static final String FN_AVAIL_MEM = "alkhawarizm_metal_available_memory";
    private static final String FN_ALLOC = "alkhawarizm_metal_alloc";
    private static final String FN_ARGMAX_F32 = "alkhawarizm_metal_argmax_f32";
    private static final String FN_MATMUL = "alkhawarizm_metal_matmul";
    private static final String FN_MATMUL_TB = "alkhawarizm_metal_matmul_tb";
    private static final String FN_MATMUL_TB_HALF = "alkhawarizm_metal_matmul_tb_half";
    private static final String FN_MATMUL_TB_HALF_PAIR = "alkhawarizm_metal_matmul_tb_half_pair";
    private static final String FN_MATMUL_TB_HALF_PAIR_MIXED = "alkhawarizm_metal_matmul_tb_half_pair_mixed";
    private static final String FN_MATMUL_TB_HALF_TRIPLE_MIXED = "alkhawarizm_metal_matmul_tb_half_triple_mixed";
    private static final String FN_SWIGLU_FFN_HALF = "alkhawarizm_metal_swiglu_ffn_half";
    private static final String FN_GEGLU_FFN_HALF = "alkhawarizm_metal_geglu_ffn_half";
    private static final String FN_SWIGLU_FFN_MATVEC_HALF = "alkhawarizm_metal_swiglu_ffn_matvec_half";
    private static final String FN_GEGLU_FFN_MATVEC_HALF = "alkhawarizm_metal_geglu_ffn_matvec_half";
    private static final String FN_SWIGLU_FFN_MATVEC_BF16 = "alkhawarizm_metal_swiglu_ffn_matvec_bf16";
    private static final String FN_GEGLU_FFN_MATVEC_BF16 = "alkhawarizm_metal_geglu_ffn_matvec_bf16";
    private static final String FN_SWIGLU_FFN_MATVEC_ROWS_BF16 = "alkhawarizm_metal_swiglu_ffn_matvec_rows_bf16";
    private static final String FN_GEGLU_FFN_MATVEC_ROWS_BF16 = "alkhawarizm_metal_geglu_ffn_matvec_rows_bf16";
    private static final String FN_BF16_FFN_MATVEC_ROWS_VARIANT = "alkhawarizm_metal_bf16_ffn_matvec_rows_variant";
    private static final String FN_MATVEC_TB_HALF = "alkhawarizm_metal_matvec_tb_half";
    private static final String FN_MATVEC_TB_HALF_MPS = "alkhawarizm_metal_matvec_tb_half_mps";
    private static final String FN_MATVEC_TB_NF4 = "alkhawarizm_metal_matvec_tb_nf4";
    private static final String FN_MATVEC_TB_INT4 = "alkhawarizm_metal_matvec_tb_int4";
    private static final String FN_MATVEC_TB_Q4_K = "alkhawarizm_metal_matvec_tb_q4_k";
    private static final String FN_MATVEC_TB_Q8_0 = "alkhawarizm_metal_matvec_tb_q8_0";
    private static final String FN_MATVEC_T_HALF = "alkhawarizm_metal_matvec_t_half";
    private static final String FN_MATVEC_TB_HALF_PAIR = "alkhawarizm_metal_matvec_tb_half_pair";
    private static final String FN_MATVEC_TB_HALF_TRIPLE_MIXED = "alkhawarizm_metal_matvec_tb_half_triple_mixed";
    private static final String FN_MATVEC_TB_BF16 = "alkhawarizm_metal_matvec_tb_bf16";
    private static final String FN_MATVEC_TB_BF16_PAIR = "alkhawarizm_metal_matvec_tb_bf16_pair";
    private static final String FN_MATVEC_TB_BF16_TRIPLE_MIXED = "alkhawarizm_metal_matvec_tb_bf16_triple_mixed";
    private static final String FN_ATTENTION = "alkhawarizm_metal_attention";
    private static final String FN_ATTENTION_GQA = "alkhawarizm_metal_attention_gqa";
    private static final String FN_ATTENTION_WINDOWED = "alkhawarizm_metal_attention_windowed";
    private static final String FN_ATTENTION_GQA_WINDOWED = "alkhawarizm_metal_attention_gqa_windowed";
    private static final String FN_FLASH_ATTENTION = "alkhawarizm_metal_flash_attention";
    private static final String FN_RMSNORM = "alkhawarizm_metal_rmsnorm";
    private static final String FN_RMSNORM_ROWS = "alkhawarizm_metal_rmsnorm_rows";
    private static final String FN_ROPE = "alkhawarizm_metal_rope";
    private static final String FN_LAYERNORM = "alkhawarizm_metal_layernorm";
    private static final String FN_LAYERNORM_ROWS = "alkhawarizm_metal_layernorm_rows";
    private static final String FN_SILU = "alkhawarizm_metal_silu";
    private static final String FN_GELU = "alkhawarizm_metal_gelu";
    private static final String FN_SOFTMAX = "alkhawarizm_metal_softmax";
    private static final String FN_SILU_FFN = "alkhawarizm_metal_silu_ffn";
    private static final String FN_GELU_FFN = "alkhawarizm_metal_gelu_ffn";
    private static final String FN_SET_MPS_MATVEC_ENABLED = "alkhawarizm_metal_set_mps_matvec_enabled";
    private static final String FN_SET_MPS_MATVEC_AUTOTUNE_ENABLED = "alkhawarizm_metal_set_mps_matvec_autotune_enabled";
    private static final String FN_SET_MPS_MATVEC_MAX_INNER = "alkhawarizm_metal_set_mps_matvec_max_inner";
    private static final String FN_SET_MPS_MATVEC_MAX_OUTPUT = "alkhawarizm_metal_set_mps_matvec_max_output";
    private static final String FN_SET_MPS_MATVEC_AUTOTUNE_MAX_OUTPUT = "alkhawarizm_metal_set_mps_matvec_autotune_max_output";
    private static final String FN_UNIFIED_MEM = "alkhawarizm_metal_is_unified_memory";
    private static final String FN_DEVICE_NAME = "alkhawarizm_metal_device_name";

    // Basic Math Operations
    private static final String FN_ADD = "alkhawarizm_metal_add";
    private static final String FN_SUB = "alkhawarizm_metal_sub";
    private static final String FN_MUL = "alkhawarizm_metal_mul";
    private static final String FN_DIV = "alkhawarizm_metal_div";
    private static final String FN_RELU = "alkhawarizm_metal_relu";
    private static final String FN_SIGMOID = "alkhawarizm_metal_sigmoid";
    private static final String FN_TANH = "alkhawarizm_metal_tanh";
    private static final String FN_EXP = "alkhawarizm_metal_exp";
    private static final String FN_LOG = "alkhawarizm_metal_log";
    private static final String FN_SUM = "alkhawarizm_metal_sum";
    private static final String FN_MEAN = "alkhawarizm_metal_mean";
    private static final String FN_POW = "alkhawarizm_metal_pow";
    private static final String FN_TRANSPOSE2D = "alkhawarizm_metal_transpose2d";
    private static final String ENABLE_ELEMENTWISE_KERNELS_PROPERTY = "alkhawarizm.metal.enable_elementwise_kernels";
    private static final String ENABLE_ELEMENTWISE_KERNELS_ENV = "ALKHAWARIZM_METAL_ENABLE_ELEMENTWISE_KERNELS";
    private static final String ENABLE_MPS_MATVEC_PROPERTY = "alkhawarizm.metal.enable_mps_matvec";
    private static final String DISABLE_MPS_MATVEC_PROPERTY = "alkhawarizm.metal.disable_mps_matvec";
    private static final String ENABLE_MPS_MATVEC_AUTOTUNE_PROPERTY = "alkhawarizm.metal.mps_matvec.autotune";
    private static final String DISABLE_MPS_MATVEC_AUTOTUNE_PROPERTY = "alkhawarizm.metal.mps_matvec.disable_autotune";
    private static final String MPS_MATVEC_MAX_INNER_PROPERTY = "alkhawarizm.metal.mps_matvec.max_inner";
    private static final String MPS_MATVEC_MAX_OUTPUT_PROPERTY = "alkhawarizm.metal.mps_matvec.max_output";
    private static final String MPS_MATVEC_AUTOTUNE_MAX_OUTPUT_PROPERTY = "alkhawarizm.metal.mps_matvec.autotune.max_output";
    ...
    private void configureMpsMatvecFromProperties() {
        ...
        if (handles.containsKey(FN_SET_MPS_MATVEC_AUTOTUNE_MAX_OUTPUT)) {
            ...
            if (parsed != null)
                setMpsMatvecAutotuneMaxOutput(parsed);
        }
    }
    ...
    public int matmulTransposedRightHalfPair(MemorySegment C0, MemorySegment C1,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matmulTransposedRightHalfPair not supported in CPU fallback");
        }
    ...
    public int matmulTransposedRightHalfPairMixed(MemorySegment C0, MemorySegment C1,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matmulTransposedRightHalfPairMixed not supported in CPU fallback");
        }
    ...
    public int matmulTransposedRightHalfTripleMixed(MemorySegment C0, MemorySegment C1, MemorySegment C2,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matmulTransposedRightHalfTripleMixed not supported in CPU fallback");
        }
    ...
    public int matvecTransposedRightQ4K(MemorySegment C, MemorySegment A, MemorySegment B, int K, int N) {
        if (useCpuFallback())
            throw new UnsupportedOperationException("Metal Q4_K not available in CPU fallback");
        if (!handles.containsKey(FN_MATVEC_TB_Q4_K))
            return -2;
    ...
    public int matvecTransposedRightQ8_0(MemorySegment C, MemorySegment A, MemorySegment B, int K, int N) {
        if (useCpuFallback())
            throw new UnsupportedOperationException("Metal Q8_0 not available in CPU fallback");
        if (!handles.containsKey(FN_MATVEC_TB_Q8_0))
            return -2;
    ...
    public int matvecTransposedRightHalfPair(MemorySegment C0, MemorySegment C1,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matvecTransposedRightHalfPair not supported in CPU fallback");
        }
    ...
    public int matvecTransposedRightBf16Pair(MemorySegment C0, MemorySegment C1,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matvecTransposedRightBf16Pair not supported in CPU fallback");
        }
    ...
    public int matvecTransposedRightHalfTripleMixed(MemorySegment C0, MemorySegment C1, MemorySegment C2,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matvecTransposedRightHalfTripleMixed not supported in CPU fallback");
        }
    ...
    public int matvecTransposedRightBf16TripleMixed(MemorySegment C0, MemorySegment C1, MemorySegment C2,
        ...
        if (useCpuFallback()) {
            throw new UnsupportedOperationException(
                    "Metal matvecTransposedRightBf16TripleMixed not supported in CPU fallback");
        }
     ...
     * <p>
     * Supports both GPT-NeoX style ({@code isNeox=true}: pairs
     * {@code [i, i+headDim/2]})
     * and LLaMA/Gemma style ({@code isNeox=false}: interleaved pairs
     * {@code [2i, 2i+1]}).
     * The {@code isNeox} flag makes the operation fully model-agnostic.
     * </p>
     *
    ...
    private void bindAll() {
        // int alkhawarizm_metal_init()
        bind(FN_INIT, FunctionDescriptor.of(ValueLayout.JAVA_INT));

        // long alkhawarizm_metal_available_memory()
        ...
        // int alkhawarizm_metal_matmul(C, A, B, M, K, N, alpha, beta)
        ...
        // int alkhawarizm_metal_rope(out, x, n, head_dim, pos_offset, freq_base,
        // is_neox)
        ...
        // int alkhawarizm_metal_rmsnorm(out, x, weight, N, eps, add_one)
        ...
        // int alkhawarizm_metal_silu_ffn(out, gate, up, N)
        bind(FN_SILU_FFN, FunctionDescriptor.of(ValueLayout.JAVA_INT,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.JAVA_INT));

        // int alkhawarizm_metal_gelu_ffn(out, gate, up, N)
        ...
        // int alkhawarizm_metal_is_unified_memory()
