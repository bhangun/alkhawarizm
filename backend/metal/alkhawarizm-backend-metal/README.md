...
```properties
# Enable Metal runner
alkhawarizm.runners.metal.enabled=true

# Runner mode: auto|standard|offload|force|disabled
alkhawarizm.runners.metal.mode=auto
...
# Output
target/native/macos-aarch64/libalkhawarizm_metal.dylib

# Install to default location
mkdir -p ~/.alkhawarizm/libs
cp target/native/macos-aarch64/libalkhawarizm_metal.dylib ~/.alkhawarizm/libs/
```
...
│                   MetalBinding (FFM)                    │
├─────────────────────────────────────────────────────────┤
│  libalkhawarizm_metal.dylib → Metal → Apple GPU             │
...
```java
import tech.kayys.alkhawarizm.metal.runner.MetalRunner;
import tech.kayys.alkhawarizm.metal.optimization.MetalOptimizationManager;
...
System.setProperty("alkhawarizm.runners.metal.mode", "offload");
...
alkhawarizm.runners.metal.mode=offload

# Or reduce model size
alkhawarizm.runners.metal.num-layers=16  # Instead of 32
```
