/**
 * aljabr_metal_matvec_api.h — exported Metal matvec C API.
 */

#ifndef ALJABR_METAL_MATVEC_API_H
#define ALJABR_METAL_MATVEC_API_H
...
int aljabr_metal_matvec_tb_bf16_pair(void* C0,
                                     void* C1,
                                     const void* A,
                                     const void* B0,
                                     const void* B1,
...
int aljabr_metal_matvec_tb_half_triple_mixed(void* C0,
                                             void* C1,
                                             void* C2,
                                             const void* A,
                                             const void* B0,
...
int aljabr_metal_matvec_tb_bf16_triple_mixed(void* C0,
                                             void* C1,
                                             void* C2,
                                             const void* A,
                                             const void* B0,
