package tech.kayys.alkhawarizm.rocm.binding;
 ...
 *
 * <p>
 * Loads {@code libamdhip64.so} at runtime and binds the key HIP runtime
 ...
 * {@link tech.kayys.alkhawarizm.kernel.fa3.FlashAttention3Binding} exactly.
 *
 * <h2>ROCm / HIP</h2>
 * <p>
 ...
 * <tr>
 * <td>cudaError_t</td>
 * <td>hipError_t (same int codes)</td>
 * </tr>
 * <tr>
 * <td>cudaMalloc</td>
 * <td>hipMalloc</td>
 ...
 * <tr>
 * <td>cudaMemcpy</td>
 * <td>hipMemcpy (same enum values)</td>
 * </tr>
 * <tr>
 * <td>cudaStream_t</td>
 * <td>hipStream_t</td>
 * </tr>
 * <tr>
 * <td>cudaDeviceProp</td>
 * <td>hipDeviceProp_t</td>
 * </tr>
 * <tr>
 * <td>cuModuleLoad</td>
 * <td>hipModuleLoad (.hsaco file)</td>
 * </tr>
 * <tr>
 * <td>cuLaunchKernel</td>
 * <td>hipModuleLaunchKernel</td>
 * </tr>
 * </table>
 *
 * <h2>MI300X specifics</h2>
 * <p>
 * The AMD MI300X has 192 GB HBM3 unified CPU+GPU memory (XDNA architecture),
...
public class RocmHipBinding {
    ...
    public int setDevice(int deviceId) {
        if (!nativeAvailable)
            return 0;
        try {
            return (int) invoke(FN_SET_DEVICE, deviceId);
        } catch (Throwable t) {
            return -1;
        }
    }
    ...
    public int deviceSynchronize() {
        if (!nativeAvailable)
            return 0;
        try {
            return (int) invoke(FN_DEVICE_SYNC);
        } catch (Throwable t) {
            return -1;
        }
    }
    ...
    public int free(MemorySegment ptr) {
        if (!nativeAvailable || isNull(ptr))
            return 0;
        try {
            return (int) invoke(FN_FREE, ptr);
        } catch (Throwable t) {
            return -1;
        }
    }
    ...
    public int memcpyH2D(MemorySegment dst, MemorySegment src, long bytes) {
        ...
        try {
            return (int) invoke(FN_MEMCPY, dst, src, bytes, HIP_MEMCPY_H2D);
        } catch (Throwable t) {
            throw new RuntimeException("hipMemcpy H2D failed", t);
        }
    }
    ...
    public int memcpyD2H(MemorySegment dst, MemorySegment src, long bytes) {
        ...
        try {
            return (int) invoke(FN_MEMCPY, dst, src, bytes, HIP_MEMCPY_D2H);
        } catch (Throwable t) {
            throw new RuntimeException("hipMemcpy D2H failed", t);
        }
    }
    ...
    public int memcpyAsyncH2D(MemorySegment dst, MemorySegment src,
        ...
        try {
            return (int) invoke(FN_MEMCPY_ASYNC, dst, src, bytes, HIP_MEMCPY_H2D, stream);
        } catch (Throwable t) {
            throw new RuntimeException("hipMemcpyAsync H2D failed", t);
        }
    }
    ...
    public int memset(MemorySegment ptr, int value, long bytes) {
        ...
        try {
            return (int) invoke(FN_MEMSET, ptr, value, bytes);
        } catch (Throwable t) {
            return -1;
        }
    }
    ...
    public int streamSynchronize(MemorySegment stream) {
        if (!nativeAvailable || isNull(stream))
            return 0;
        try {
            return (int) invoke(FN_STREAM_SYNC, stream);
        } catch (Throwable t) {
            return -1;
        }
    }
    ...
    public int streamDestroy(MemorySegment stream) {
        if (!nativeAvailable || isNull(stream))
            return 0;
        try {
            return (int) invoke(FN_STREAM_DESTROY, stream);
        } catch (Throwable t) {
            return -1;
        }
    }
     ...
     *
     * <p>
     * The {@code .hsaco} file is compiled from CUDA source using
    ...
    public MemorySegment moduleGetFunction(MemorySegment module, String fnName) {
        if (!nativeAvailable || isNull(module))
            return MemorySegment.NULL;
        try (Arena a = Arena.ofConfined()) {
    ...
    private Object invoke(String fn, Object... args) {
        ...
        if (mh == null)
            throw new IllegalStateException("HIP symbol not bound: " + fn);
        try {
            return mh.invokeWithArguments(args);
        } catch (Throwable t) {
            throw new RuntimeException("HIP " + fn + " failed", t);
        }
    }
