...
```properties
# Enable ROCm runner
alkhawarizm.runners.rocm.enabled=true
...
alkhawarizm.runners.rocm.use-managed-memory=true
...
# Output
target/native/linux-x86_64/libalkhawarizm_rocm_gfx942.hsaco
```
...
```java
import tech.kayys.alkhawarizm.rocm.runner.RocmRunner;
import tech.kayys.alkhawarizm.rocm.optimization.RocmOptimizationManager;
