...
object DirectFixtureCoverageReportSpec {
    ...
    val schemaId =
        "https://alkhawarizm.ai/schemas/build/model-family-direct-fixtures.v$schemaVersion.schema.json"

    const val moduleNamePattern = "^alkhawarizm-model-[a-z0-9-]+$"
    const val moduleNamePrefix = "alkhawarizm-model-"
