 ...
 * Tensor out = model.forward(input); // [B, 3, 224, 224] → [B, 1000]
 * }</pre>
 */
public final class ResNet {
     ...
     * @return ResNet-18 {@link NNModule}
     */
     ...
     *
     * @param numClasses number of output classes
     * @return ResNet-34 {@link NNModule}
     */
     ...
     *
     * @param numClasses number of output classes
     * @return ResNet-50 {@link NNModule}
     */
    ...
    private static final class ResNetModel extends NNModule {
        ...
        public Tensor forward(Tensor x) {
            ...
            return fc.forward(Tensor.of(pooled, B, C));
        }
    ...
    static final class BottleneckBlock extends NNModule {
        ...
        public Tensor forward(Tensor x) {
            Tensor identity = x;
            Tensor out = bn1.forward(conv1.forward(x)).relu();
