 ...
 *
 * <p>
 * Uses the TFRecord binary format (length-prefixed protobuf records)
...
public final class TensorBoardWriter implements AutoCloseable {
    ...
    public TensorBoardWriter(Path logDir) throws IOException {
        ...
        String filename = "events.out.tfevents." + System.currentTimeMillis() + ".alkhawarizm";
