 ...
 * <p>
 * Common use case: Stop training if validation loss doesn't improve for N
 * epochs.
 *
 ...
 * <h3>Parameters</h3>
 * <ul>
 * <li><b>patience:</b> Number of checks without improvement before
 * stopping</li>
 * <li><b>restoreBest:</b> Whether to restore best model weights</li>
 * <li><b>minDelta:</b> Minimum change to qualify as improvement (in
 * percentage)</li>
