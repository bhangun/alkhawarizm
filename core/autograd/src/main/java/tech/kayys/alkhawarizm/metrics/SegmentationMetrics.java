package tech.kayys.alkhawarizm.ml.metrics;

import tech.kayys.alkhawarizm.ml.autograd.VectorOps;

/**
 * Intersection over Union (IoU) and Dice Score for segmentation evaluation.
 *
 * <p>
 * Both metrics measure overlap between predicted and ground-truth masks.
...
public final class SegmentationMetrics {
     ...
     *
     * @param pred       predicted class mask {@code [N]} (integer class indices as
     *                   float)
