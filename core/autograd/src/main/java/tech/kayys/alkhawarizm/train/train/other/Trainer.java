package tech.kayys.alkhawarizm.ml.train.other;

import tech.kayys.alkhawarizm.ml.autograd.GradTensor;
import tech.kayys.alkhawarizm.ml.nn.NNModule;
import tech.kayys.alkhawarizm.ml.nn.loss.CrossEntropyLoss;
...
public class Trainer {
    ...
    public static class Builder {
        ...
        public Builder lossFunction(BiFunction<GradTensor, GradTensor, GradTensor> loss) {
        ...
        public Builder callback(TrainingCallback callback) {
        ...
        public Trainer build() {
            ...
            if (optimizer == null)
                throw new IllegalStateException("optimizer is required");
            if (lossFunction == null)
                throw new IllegalStateException("lossFunction is required");
