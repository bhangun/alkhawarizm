package tech.kayys.alkhawarizm;

import tech.kayys.alkhawarizm.autograd.*;
import tech.kayys.alkhawarizm.core.util.ThreadPools;
import tech.kayys.alkhawarizm.ir.OpRegistry;
import tech.kayys.alkhawarizm.ir.OpSchemaRegistry;
import tech.kayys.alkhawarizm.core.tensor.Tensor;

/**
 * Central initialization point for Alkhawarizm ML.
 * Call this once at application startup.
 * @author bhangun
 */
public final class AlkhawarizmInitializer {
    ...
    private AlkhawarizmInitializer() {
    } // Prevent instantiation

    /**
     * Initialize all Alkhawarizm systems.
     * Call this once at application startup.
     */
    public static synchronized void initialize() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            System.out.println("Shutting down Alkhawarizm...");
            // Clean up resources
    ...
    private static void checkInitialized() {
        if (!initialized) {
            throw new IllegalStateException(
                    "Alkhawarizm not initialized. Call AlkhawarizmInitializer.initialize() first.");
        }
    }
