...
import tech.kayys.alkhawarizm.converter.gguf.SafetensorToGgufConverter;
...
public class GGUFConverter {
    ...
    private static final String DEFAULT_CONVERTER_BASE = System.getProperty("user.home") + "/.alkhawarizm/conversions";
    private static final String DEFAULT_MODEL_BASE = System.getProperty("user.home") + "/.alkhawarizm/models";
    ...
    public Path resolveModelBasePath() {
        return resolveBasePath("ALKHAWARIZM_MODEL_BASE", "alkhawarizm.model.base", DEFAULT_MODEL_BASE);
    }

    public Path resolveConverterBasePath() {
        return resolveBasePath("ALKHAWARIZM_CONVERTER_BASE", "alkhawarizm.converter.base", DEFAULT_CONVERTER_BASE);
    }
