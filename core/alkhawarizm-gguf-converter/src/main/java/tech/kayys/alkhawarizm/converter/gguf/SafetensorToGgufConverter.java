        ...
        try (Arena arena = Arena.ofConfined();
            ...
            if (nativeQuantizer == null && isKQuant(dstType)) {
                throw new IOException("Native ggml quantizer is required for " + dstType.label
                        ...
                        + "Set ALKHAWARIZM_GGML_LIB_DIR or -Dalkhawarizm.gguf.ggml.libdir to a llama.cpp build/lib directory, "
                        + "or convert to F16/BF16 first.");
            }
            if (nativeQuantizer != null && Boolean.getBoolean("alkhawarizm.gguf.native_quant.debug")) {
