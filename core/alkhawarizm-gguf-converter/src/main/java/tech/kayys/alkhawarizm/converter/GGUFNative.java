package tech.kayys.alkhawarizm.converter;
...
public final class GGUFNative {
    ...
    static {
        ...
        if (!AVAILABLE) {
            try {
                String explicitLibPath = System.getProperty("alkhawarizm.gguf.native.library.path");
        ...
        // Strategy 2: Extract from JAR classpath resource to versioned ~/.alkhawarizm/libs/
        if (!AVAILABLE) {
            try {
        ...
        // Strategy 3: Standard ~/.alkhawarizm/libs/gguf_bridge/1.0.0/ location (permanent installation)
        if (!AVAILABLE) {
            try {
            ...
            if (LOAD_ERROR == null) {
                LOAD_ERROR = new UnsatisfiedLinkError(
                        "GGUF native bridge '" + LIBRARY_NAME
                                ...
                                + "build directory, or ~/.alkhawarizm/libs/");
            }
     ...
     * under {@code ~/.alkhawarizm/libs/gguf_bridge/<version>/}.
    ...
    private static Path extractFromClasspath() {
        ...
        try (InputStream stream = GGUFNative.class.getClassLoader()
            ...
            Path extractDir = Path.of(System.getProperty("user.home"),
                    ".alkhawarizm", "libs", LIBRARY_NAME, LIBRARY_VERSION);
    ...
    private static Path findBuildDirectoryLib() {
        ...
        String[] devPaths = {
                ...
                "alkhawarizm/plugins/runner/gguf/gguf-bridge/build/" + libFileName,
                ...
                "alkhawarizm/plugins/runner/gguf/gguf-bridge/target/" + libFileName,
                "../target/" + libFileName,
                "target/" + libFileName,
                
                // CMake build subdirectories
                "alkhawarizm/plugins/runner/gguf/gguf-bridge/build/Release/" + libFileName,
                "alkhawarizm/plugins/runner/gguf/gguf-bridge/build/Debug/" + libFileName,
                "alkhawarizm/plugins/runner/gguf/gguf-bridge/build/RelWithDebInfo/" + libFileName,
                
                // Alternative build locations
                "alkhawarizm/plugins/runner/gguf/build/" + libFileName,
                "alkhawarizm/plugins/runner/build/" + libFileName,
                
                // User home build location
                Path.of(System.getProperty("user.home"), ".alkhawarizm", "source", "gguf-bridge", "build", libFileName).toString(),
        };
    ...
    /**
     * Install the native library to the standard location (~/.alkhawarizm/libs/gguf_bridge/1.0.0/).
     ...
     * 
     * @return true if the library exists at ~/.alkhawarizm/libs/gguf_bridge/1.0.0/
     */
    ...
    private static Path getStandardLibPath() {
        return Path.of(System.getProperty("user.home"),
                ".alkhawarizm", "libs", LIBRARY_NAME, LIBRARY_VERSION, getNativeLibFileName());
    }
