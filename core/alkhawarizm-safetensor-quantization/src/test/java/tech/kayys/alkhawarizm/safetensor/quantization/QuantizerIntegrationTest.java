 ...
 */
package tech.kayys.alkhawarizm.safetensor.quantization;

import tech.kayys.alkhawarizm.safetensor.quantization.quantizer.GPTQQuantizerAdapter;
import tech.kayys.alkhawarizm.safetensor.quantization.quantizer.Quantizer;
...
class QuantizerIntegrationTest {
    ...
    void testCustomQuantizerRegistration() {
        ...
        Quantizer custom = new Quantizer() {
            @Override
            public tech.kayys.alkhawarizm.safetensor.core.tensor.AccelTensor quantizeTensor(
                    tech.kayys.alkhawarizm.safetensor.core.tensor.AccelTensor tensor, QuantConfig config) {
                return tensor;
            }

            @Override
            public tech.kayys.alkhawarizm.safetensor.core.tensor.AccelTensor dequantizeTensor(
                    tech.kayys.alkhawarizm.safetensor.core.tensor.AccelTensor tensor, QuantConfig config) {
                return tensor;
            }
    ...
    void testSafetensorLoaderOnClasspath() {
        assertDoesNotThrow(() -> Class.forName("tech.kayys.alkhawarizm.safetensor.loader.SafetensorHeader"),
                "Safetensor loader should be on classpath");
        assertDoesNotThrow(() -> Class.forName("tech.kayys.alkhawarizm.safetensor.loader.SafetensorTensorInfo"),
