package tech.kayys.alkhawarizm.safetensor.quantization.quantizer;

import tech.kayys.alkhawarizm.safetensor.core.tensor.AccelTensor;
import tech.kayys.alkhawarizm.safetensor.quantization.QuantConfig;
...
public class BnBQuantizerAdapter implements Quantizer {
    ...
    public boolean supports(QuantConfig config) {
        return config.getStrategy() == tech.kayys.alkhawarizm.safetensor.quantization.QuantizationEngine.QuantStrategy.INT8
