...
import static tech.kayys.alkhawarizm.gguf.runtime.GgufFx.assertSingleRowMatVecMatchesDot;
import static tech.kayys.alkhawarizm.gguf.runtime.GgufFx.ramp;
import static tech.kayys.alkhawarizm.gguf.runtime.GgufFx.restoreProperty;
import static tech.kayys.alkhawarizm.gguf.runtime.GgufKFx.writeQ2KNoMinLaneOrderBlock;
import static tech.kayys.alkhawarizm.gguf.runtime.GgufKFx.writeQ4KNoMinLaneOrderBlock;
import static tech.kayys.alkhawarizm.gguf.runtime.GgufKFx.writeQ5KNoMinLaneOrderBlock;

class GgufKNoMinOneTest {
    @Test
    void rawNoMinKMatVecUsesDirectDotPathForSingleDecodeRow() {
        String previousQ2MinRows = System.getProperty("alkhawarizm.gguf.q2k.cache_min_rows");
        ...
        System.setProperty("alkhawarizm.gguf.q2k.cache_max_bytes", "1");
        System.setProperty("alkhawarizm.gguf.q4k.cache_min_rows", "1");
        System.setProperty("alkhawarizm.gguf.q4k.cache_max_bytes", "1");
        ...
        try (Arena arena = Arena.ofShared()) {
            ...
            restoreProperty("alkhawarizm.gguf.q2k.cache_min_rows", previousQ2MinRows);
