 ...
 * @since 0.1.0
 */
public class AlkhawarizmWeightAdapter implements WeightAdapter {
    ...
    public AlkhawarizmWeightAdapter(GGUFFile gguf) {
        this.gguf = gguf;
    ...
    private tech.kayys.alkhawarizm.core.tensor.DType mapDType(tech.kayys.alkhawarizm.gguf.core.GgmlType ggmlType) {
        switch (ggmlType) {
            case F32:
