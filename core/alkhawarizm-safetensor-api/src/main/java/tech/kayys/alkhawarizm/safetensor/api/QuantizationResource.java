...
import tech.kayys.alkhawarizm.safetensor.api.dto.QuantizationResponse;
import tech.kayys.alkhawarizm.safetensor.api.dto.QuantizationRequest;
    ...
    public Response quantize(@RequestBody(description = "Quantization request") QuantizationRequest request) {
        ...
        try {
            ...
            Class<?> strategyEnum = Class
                    .forName("tech.kayys.alkhawarizm.safetensor.quantization.QuantizationEngine$QuantStrategy");
            Object strategy = Enum.valueOf((Class<Enum>) strategyEnum, request.getStrategy().toUpperCase());

            Class<?> configClass = Class.forName("tech.kayys.alkhawarizm.safetensor.quantization.QuantConfig");
